...
export default function SideBar({fullname ,navigationChildren, footNavigationChild }:SideBarProps){
  return (
      <aside className="w-80 text-white min-h-screen font-sans bg-[#111111] p-4 flex flex-col justify-between">
        <div>
          {/* User Profile */}
          <div className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-800 cursor-pointer">
            <div className="flex items-center">
               <Avatar className="w-10 h-10">
                    <AvatarImage className='rounded-full w-full h-full object-cover' src='/tanisha.png'  alt="@shannons" />
            ...
            <div className="flex items-center">
              <span className="bg-[#BDFD2F] text-gray-900 text-[8px] font-bold px-2 py-0.5 rounded-full mr-3">USER</span>
            </div>
          </div>
